...
class __TwigTemplate_bd1136fdf70a9938e7f277fe7635cd0a55c41a4a860c877f6512547f7f664952 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["category"], "thumb", [], "any", false, false, false, 5)) {
                    ...
                    echo "\" title=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 6);
                    echo "\" class=\"img-thumbnail\" style=\"margin: 0 10px 5px 0\" /></div>
        ";
                }
                // line 8
